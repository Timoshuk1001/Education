...
//
// function tryGuess() {
//     let userPersonInput = Number(inputPersonNum.value);
//     let randomNumber = result;
//     let countTry = Number(attempts.value);
//
//     if (countGuess === 1) {
//         lastNumber2.textContent = 'Предыдущие варианты: ';
//     }
//     lastNumber2.textContent += userPersonInput + ' ';
//
//     if (userPersonInput === randomNumber) {
//         lastResult2.textContent = 'Поздравляю! Ты угадал число за ' + countGuess;
//         if (countGuess < 5) {
//             lastResult2.textContent += ' попытки!';
//         } else lastResult2.textContent += ' попыток!';
//         lowOrHi2.textContent = ' ';
//         gameOver()
//     } else if (countGuess === countTry) {
//         inputPersonNum.disabled = true;
//         getTry2.disabled = true;
//         lastResult2.textContent = 'Попытки кончились!'
//         gameOver()
...
//         if (userPersonInput < randomNumber) {
//             lowOrHi2.textContent = 'Число меньше чем загаданное!';
//         } else if (userPersonInput > randomNumber) {
//             lowOrHi2.textContent = 'Число больше чем загаданное!';
//         }
//     }
//     countGuess++;
//     inputPersonNum.value = '';
//     inputPersonNum.focus();
//     inputPersonNum.hidden = false;
//     start.hidden = false;
//
// }
